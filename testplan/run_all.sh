...
run "mask layers XMP persistence" testplan/auto/t_mask_layers_xmp.py testplan/auto/t_mask_groups.py testplan/auto/t_mask_delete_key.py testplan/auto/t_mask_group_ui.py testplan/auto/t_mask_group_undo.py testplan/auto/t_down_key_discard.py testplan/auto/t_gallery_new_file.py testplan/auto/t_gallery_thumb_recovery.py testplan/auto/t_worker_no_qpixmap.py testplan/auto/t_raw_slot_accounting.py
