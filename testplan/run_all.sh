...
run "generative backend (parked -- no UI)" testplan/auto/t_generative_session.py testplan/auto/t_generative_local.py testplan/auto/t_generative_local_server.py
