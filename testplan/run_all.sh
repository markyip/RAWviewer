...
run "generative panel + consent (headless UI)" testplan/auto/t_generative_panel.py t_generative_tab.py t_generative_session.py t_generative_local.py t_generative_local_server.py
