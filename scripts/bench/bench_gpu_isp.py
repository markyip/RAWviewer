...
Spike diagnosis modes:
  ...
  pixi run python scripts/bench/bench_gpu_isp.py FILE --mode wall --repeats 7

  # Stage breakdown with sync (attribution):
  pixi run python scripts/bench/bench_gpu_isp.py FILE --mode stages --repeats 7

  # Both: wall first, then stages (default):
  pixi run python scripts/bench/bench_gpu_isp.py FILE --mode both --repeats 7
