# -*- coding: utf-8 -*-
"""NAFNet architecture (megvii-research/NAFNet), vendored for ONNX export only.

Source: https://github.com/megvii-research/NAFNet/blob/main/basicsr/models/archs/NAFNet_arch.py
Trimmed: dropped NAFNetLocal / Local_Base (training-time patch-averaging variant,
not needed for a straight forward-pass export) and the arch_util LayerNorm2d
custom-autograd class, inlined as plain ops (identical forward math, and
torch.onnx.export traces the forward pass either way).
"""
import torch
