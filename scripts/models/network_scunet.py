# -*- coding: utf-8 -*-
"""SCUNet architecture (cszn/SCUNet, KAIR), vendored for ONNX export only.

Source: https://github.com/cszn/SCUNet/blob/main/models/network_scunet.py
Trimmed: dropped the unused `thop` profiling import/usage.
"""
import torch
