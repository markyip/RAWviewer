...
Dev helper for populating ``models/mobileclip2_coreml/`` or
``~/.rawviewer_cache/mobileclip_coreml``. Packaged macOS apps download
in-app on first search; this script is optional for offline prep.

Example:
    python scripts/models/download_mobileclip_coreml.py --out-dir models/mobileclip2_coreml
"""
