...
if [ "$FOUND" -eq 0 ]; then
    echo "  (none — build with ./scripts/Launch/macos/build_macos_full.sh)"
fi

echo ""
echo "[4/4] Dev launch commands:"
echo "  ./scripts/Launch/macos/launch_dev_full.sh"
echo "  ./scripts/Launch/macos/launch_dev_lite.sh"
echo "  ./scripts/Launch/macos/clear_cache.sh"
echo ""
