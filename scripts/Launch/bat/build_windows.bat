...
pip install --upgrade PyQt6 rawpy send2trash pyinstaller natsort exifread pyexiv2 Pillow psutil numpy qtawesome pyqtgraph onnxruntime-directml reverse-geocoder pycountry pywin32 comtypes "winrt-Windows.ApplicationModel.DataTransfer" "winrt-Windows.Storage" opencv-python-headless huggingface-hub requests
