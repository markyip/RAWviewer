...
if "%FOUND%"=="0" echo   (none — build with build_windows_full.bat / build_windows_lite.bat)

echo.
echo [4/4] Dev launch commands:
echo   scripts\Launch\bat\launch_dev_full.bat
echo   scripts\Launch\bat\launch_dev_lite.bat
echo   scripts\Launch\bat\run_debug.bat   ^(full, verbose debug^)
echo.
