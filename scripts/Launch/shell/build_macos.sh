...
CORE_DEPS="PyQt6 rawpy send2trash pyinstaller natsort exifread Pillow psutil numpy qtawesome pycountry certifi pyobjc-framework-Cocoa pyobjc-framework-Quartz"
