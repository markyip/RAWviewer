...
**Tests:** `PYTHONPATH=src python3 scripts/test/phase_develop_adjust_linear.py`
...
- **Verified**: `raw_lens_correction.py` has real smoke tests in
  ...
  run via `pixi run python3 scripts/test/phase_develop_adjust_linear.py` to
...
| `scripts/test/phase_develop_adjust_linear.py` | Smoke tests |
...
17. **Tone curve** — drag a point on the graph, and PV Shad/Dark/Light/High
    ...
    on the curve
18. `PYTHONPATH=src python3 scripts/test/phase_develop_adjust_linear.py`
...
21. `PYTHONPATH=src pixi run python3 scripts/test/phase_develop_adjust_linear.py`
...
`scripts/test/phase_develop_adjust_linear.py`'s helpers for a repeatable check.
